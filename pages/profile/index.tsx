...
export default function Profile() {
  ...
  return <div className="space-y-4">
    ...
    />
    <FormSubmit text="Set password"
      onClick={() => {
        changePassword();
      }}
    />
    <h2>Sign Out of All Sessions</h2>
    <p>Clicking the button below will sign you out of all sessions <em>including this one</em>.</p>
    <FormSubmit text="Sign Out of All Sessions"
      onClick={() => {
        SignOut();
      }}
    />
