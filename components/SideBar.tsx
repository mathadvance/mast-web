...
function SideBar() {
  return (
    <div className="grid grid-cols-1 widephone:grid-cols-2 sm:grid-cols-1 gap-y-1.5 bg-pink-50 dark:bg-pink-800 rounded-xl border border-pink-500 dark:border-0 p-4">
